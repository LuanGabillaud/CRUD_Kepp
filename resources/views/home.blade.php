...
<html lang="pt-br">
  <header>
    ...
    <title>Home</title>
    <!-- Bootstrap core CSS -->
    <link href="http://localhost/CRUD_Keep/bootstrap/bootstrap-4.1.3/dist/css/bootstrap.min.css" rel="stylesheet">
  ...
  <body>
    ...
    <header>
      <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        <a class="navbar-brand" href="http://localhost/CRUD_Keep/resources/views/home.php"><img src="http://localhost/CRUD_Keep/img/keep logo.png" width="50%" ></a>
    ...
    <main role="main">
      ...
      <div class="container marketing">
        ...
        <div class="row featurette">
          ...
          <div class="col-md-5">
            <img class="featurette-image img-fluid mx-auto" src="http://localhost/CRUD_Keep/img/empresas_500x500.png" alt="Generic placeholder image">
          </div>
        </div>
        ...
        <div class="row featurette">
          ...
          <div class="col-md-5 order-md-1">
            <img class="featurette-image img-fluid mx-auto" src="http://localhost/CRUD_Keep/img/clientes_500x500.png" alt="Generic placeholder image">
          </div>
        </div>
