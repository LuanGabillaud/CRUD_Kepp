...
<html lang="en">
  ...
  <div class="form-row">
    <div class="col-md-4 mb-3">
      ...
      <input type="text" class="form-control" id="validationCustom01" placeholder="ex: Industria alimenticia" required>
    ...
    <div class="col-md-4 mb-3">
      ...
      <input type="text" class="form-control" id="validationCustom02" placeholder="ex: King Food" required>
      <div class="valid-feedback">
        Tudo certo!
      </div>
    </div>
    <div class="col-md-4 mb-3">
      <label for="validationCustomUsername">CNPJ:</label>
      <div class="input-group">
        <div class="input-group-prepend">
          <span class="input-group-text" id="inputGroupPrepend">@</span>
        </div>
        <input type="number" class="form-control" id="validationCustomUsername" placeholder="ex:11.111.111/1111-11" aria-describedby="inputGroupPrepend" required>
  ...
  <div class="form-row">
    <div class="col-md-6 mb-3">
      ...
      <input type="text" class="form-control" id="validationCustom03" placeholder="ex:joana@gmail.com" required>
      <div class="invalid-feedback">
    ...
    <div class="col-md-3 mb-3">
      <label for="validationCustom05">Endereço/CEP:</label>
      <input type="text" class="form-control" id="validationCustom05" placeholder="CEP" required>
      <div class="invalid-feedback">
        Por favor, informe um CEP ou Endereço valido.
      </div>
    </div>
  </div>
